...
## since `v2.4.0` choose an `TARGETARCH` to build for

> At the moment we're providing images for:
> - Linux amd64
> - Linux arm64

https://github.com/Kong/kubernetes-ingress-controller#container-images

commited here:
👉 https://github.com/Kong/kubernetes-ingress-controller/commit/22e53cdcb23c3bf908b4e4ae951eedb0b4b671fd


# ~~This branch is for building `KIC` for `arm64`~~

To see the prev. workaround [goto `v2.3.1-arm64`](https://github.com/michael-riha/kubernetes-ingress-controller/tree/v2.3.1-arm64#what-i-have-done) 🤦‍♂️
